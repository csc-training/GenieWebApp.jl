...
requirejs.config({
  paths: {
    ...
    'highlight-nginx': 'https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.0.1/languages/nginx.min',
...
////////////////////////////////////////////////////////////////////////////////
require(['jquery', 'highlight', 'highlight-julia', 'highlight-julia-repl', 'highlight-dockerfile', 'highlight-nginx'], function($) {
$(document).ready(function() {
    hljs.highlightAll();
})
