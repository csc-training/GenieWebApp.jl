...
3. **Deploy the containerized application to a cloud platform**: Then, we can deploy the container image on the cloud. We demonstrate how to deploy the application and set up persistent storage with OpenShift on [**CSC Rahti**](https://rahti.csc.fi/).
